...
printf '##########################################
#                                        #
#   安装 maven 3.0.5/3.3.9/3.5.4         #
#                                        #
##########################################
1: Install maven 3.0.5
2: Install maven 3.2.9
3: Install maven 3.5.4
4: EXIT'
# 选择安装软件版本
read -p "Please input your choice:" softversion
case "${softversion}" in
    1)URL="https://anchnet-script.oss-cn-shanghai.aliyuncs.com/maven/apache-maven-3.0.5-bin.tar.gz";;
    2)URL="https://anchnet-script.oss-cn-shanghai.aliyuncs.com/maven/apache-maven-3.3.9-bin.tar.gz";;
    3)URL="https://anchnet-script.oss-cn-shanghai.aliyuncs.com/maven/apache-maven-3.5.4-bin.tar.gz";;
...
software_name=$(sed 's|.*/||;s|-bin.tar.gz||' <<< "$URL")

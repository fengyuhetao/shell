...
printf '##########################################
#                                        #
#   安装 filebeat 5.6.1/6.1.3/6.3.2      #
#                                        #
##########################################
1: Install filebeat 5.6.1
2: Install filebeat 6.1.3
3: Install filebeat 6.3.2
4: EXIT'
# 选择安装软件版本
read -p "Please input your choice:" softversion
case "${softversion}" in
    1)URL="https://anchnet-script.oss-cn-shanghai.aliyuncs.com/filebeat/filebeat-5.6.1-linux-x86_64.tar.gz";;
    2)URL="https://anchnet-script.oss-cn-shanghai.aliyuncs.com/filebeat/filebeat-6.1.3-linux-x86_64.tar.gz";;
    3)URL="https://anchnet-script.oss-cn-shanghai.aliyuncs.com/filebeat/filebeat-6.3.2-linux-x86_64.tar.gz";;

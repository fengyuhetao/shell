...
printf '##########################################
#                                        #
#   安装 kibana 6.0.1/6.2.4/6.3.1        #
#                                        #
##########################################
1: Install kibana 6.0.1
2: Install kibana 6.2.4
3: Install kibana 6.3.1
4: EXIT'
# 选择安装软件版本
read -p "Please input your choice:" softversion
case "${softversion}" in
    1)URL="https://anchnet-script.oss-cn-shanghai.aliyuncs.com/kibana/kibana-6.0.1-linux-x86_64.tar.gz";;
    2)URL="https://anchnet-script.oss-cn-shanghai.aliyuncs.com/kibana/kibana-6.2.4-linux-x86_64.tar.gz";;
    3)URL="https://anchnet-script.oss-cn-shanghai.aliyuncs.com/kibana/kibana-6.3.1-linux-x86_64.tar.gz";;

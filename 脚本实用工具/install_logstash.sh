...
printf '##########################################
#                                        #
#      安装 logstash 5.4/6.1/6.3         #
#                                        #
##########################################
1: Install logstash-5.4
2: Install logstash-6.1
3: Install logstash-6.3
4: EXIT'
# 选择安装软件版本
read -p "Please input your choice:" softversion
case "${softversion}" in
    1)URL="https://anchnet-script.oss-cn-shanghai.aliyuncs.com/logstash/logstash-5.4.1.tar.gz";;
    2)URL="https://anchnet-script.oss-cn-shanghai.aliyuncs.com/logstash/logstash-6.1.3.tar.gz";;
    3)URL="https://anchnet-script.oss-cn-shanghai.aliyuncs.com/logstash/logstash-6.3.2.tar.gz";;
